...
void ParticleSystem::DebugUI()
{
    if (ImGui::CollapsingHeader("ParticleSystem"))
    {
        ...
        ImGui::DragIntRange2("PerEmit", &mInfo.particlePerEmit.min, &mInfo.particlePerEmit.max);
        ...
        ImGui::ColorEdit4("StarColorMin", &mInfo.startColor.min.r);
        ImGui::ColorEdit4("StarColorMax", &mInfo.startColor.max.r);
...
{
    int numParticles = mInfo.particlePerEmit.GetRandomInc();
...
void ParticleSystem::SpawnSingleParticle()
{
    ...
    Math::Matrix4 matRottation = matRotRight * matRotUp;
    Math::Vector3 spawnDirection = Math::TransformCoord(mInfo.spawnDirection, matRottation);
