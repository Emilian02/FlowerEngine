...
{
    ASSERT(sUIFont == nullptr, "UIFont: is aleady initialized");
...
UIFont::~UIFont()
{
    ASSERT(sUIFont == nullptr && mFontWrapper == nullptr, "UIFont: terminate must be called");
}
...
void UIFont::Initialize(FontType font)
{
    ...
    ASSERT(SUCCEEDED(hr), "IUFont: failed to create font wrapper");
}
