...
namespace
{
    D3D11_FILTER GetFilter(Sampler::Filter filter)
    {
        switch (filter)
        {
        case Sampler::Filter::Point:        return D3D11_FILTER_COMPARISON_MIN_MAG_MIP_POINT;
        case Sampler::Filter::Linear:       return D3D11_FILTER_COMPARISON_MIN_MAG_MIP_LINEAR;
