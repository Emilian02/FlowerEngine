...
{
    const Math::Vector3 defualtForward = Math::Vector3::ZAxis;
    const Math::Vector3 defualtRight = Math::Vector3::XAxis;
    const Math::Vector3 defualtUp = Math::Vector3::YAxis;
...
Math::Matrix4 FlowerEngine::Graphics::Camera::GetProjectionMatrix() const
{
    return (mProjectionMode == ProjectionMode::Perpective)
        ? GetPerpectiveMatrix() : GetOrthographicMatrix();
}

Math::Matrix4 FlowerEngine::Graphics::Camera::GetPerpectiveMatrix() const
{
...
Math::Matrix4 FlowerEngine::Graphics::Camera::GetOrthographicMatrix() const
{
